#define VERSION "5.2 - July 1, 2021"
#define SWITCHES "[-uagsETh -Ac#txm#P#bpe#f#q -odGVX -v]"
#define TMP

/* 
Tento subor pochadza zo stranky: 
...
#endif
#if !defined(CLK_TCK)
#define CLK_TCK 60     /* If the CPU time stated by the program appears to be
		       out by a constant ratio, the most likely explanation
                       is that the code got to this point but 60 is the wrong
                       guess.  Other common values are 100 and 1000. */
#endif
#endif
